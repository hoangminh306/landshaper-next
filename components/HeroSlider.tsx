...
const slides = [
  ...
  },
  {
    ...
    title: "Giải pháp bảo vệ cây trồng hiệu quả & bền vững",
    description:
      "Chúng tôi cung cấp các dòng thuốc bảo vệ thực vật chất lượng cao, giúp phòng trừ sâu bệnh hiệu quả, nâng cao năng suất và bảo vệ môi trường canh tác lâu dài.",
  },
];
...
const HeroSlider = () => {
  ...
  return (
    <section
      id="home"
      className="relative h-[80vh] md:h-[90vh] lg:h-[100vh] min-h-[500px] md:min-h-[600px] overflow-hidden"
    >
