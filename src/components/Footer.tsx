          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <div>
                  <span className="font-serif text-xl font-bold">Landshaper</span>
                </div>
              </div>
              <p className="text-dark-foreground/70 mb-6 leading-relaxed">
                Creating beautiful outdoor spaces since 1982. We provide professional landscaping 
                services for residential and commercial properties.
              </p>
              <div className="flex gap-3">
                <a href="#" className="w-10 h-10 bg-dark-foreground/10 hover:bg-primary flex items-center justify-center transition-colors">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-dark-foreground/70">
                    123 Garden Street, Suite 100<br />
                    Portland, Oregon 97201
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                  <a href="tel:+1234567890" className="text-dark-foreground/70 hover:text-primary transition-colors">
                    +1 234 567 890
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Mail className="w-5 h-5 text-primary flex-shrink-0" />
                  <a href="mailto:info@landshaper.com" className="text-dark-foreground/70 hover:text-primary transition-colors">
                    info@landshaper.com
                  </a>
                </div>
              </div>
      ...
      <div className="border-t border-dark-foreground/10 py-6">
        <div className="container-custom flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm">
            <a href="#" className="text-dark-foreground/60 hover:text-primary transition-colors">Privacy Policy</a>
            <a href="#" className="text-dark-foreground/60 hover:text-primary transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
