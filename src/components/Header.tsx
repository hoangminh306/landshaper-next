...
import { Menu, X, Phone, Mail, Clock, Facebook, Twitter, Instagram, Linkedin, ChevronDown } from "lucide-react";
      ...
      <div className="hidden lg:block bg-dark text-dark-foreground py-3">
        <div className="container-custom flex justify-between items-center">
          <div className="flex items-center gap-6 text-sm">
            ...
            <a href="mailto:info@landshaper.com" className="flex items-center gap-2 hover:text-primary transition-colors">
        ...
        <div className="container-custom flex justify-between items-center">
          ...
          <a href="#home" className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="font-serif text-xl font-bold text-foreground">Landshaper</span>
